<nav class="side-navbar">
    <div class="side-navbar-wrapper">
        ...
        <div class="sidenav-header d-flex align-items-center justify-content-center">
            ...
            <div class="sidenav-header-logo"><a href="<?php echo e(site_url()); ?>" class="brand-small text-center"> <strong>B</strong><strong class="text-primary">D</strong></a></div>
        </div>
...
<?php /* E:\Coding\Web\ci-catatan\application\views/template/sidebar.blade.php */ ?>