                    ...
                    <div class="form-inner">
                        ...
                        <form method="post" action="<?= site_url('auth/login')?>" class="text-left form-validate">
                            <div class="form-group-material <?=get_flashdata('error')? "has-error" : null?>" >
                                <input id="login-username" type="text" name="username" required data-msg="Please enter your username" class="input-material <?=get_flashdata('error')? "is-invalid" : null?>" @if(get_flashdata('error')) autofocus @endif>
                                <label for="login-username" class="label-material">@if(get_flashdata('error')) {{get_flashdata('error')}} @else Username @endif</label>
                            </div>
                            <div class="form-group-material <?=get_flashdata('error_pass')? "has-error" : null?>">
                                <input id="login-password" type="password" name="password" required data-msg="Please enter your password" class="input-material  <?=get_flashdata('error_pass')? "is-invalid" : null?>" @if(get_flashdata('error_pass')) autofocus @endif>
                                <label for="login-password" class="label-material">@if(get_flashdata('error_pass')) {{get_flashdata('error_pass')}} @else Password @endif</label>
                            </div>
